...
import { Directions, Email, Phone, Profile, UserScan } from '../../../helpers';
...
const PersonalInfoStep = ({
  ...
  return (
    <>
      ...
      />
      <Input
        label={translate('personalInfo.documentNumber')}
        placeholder={translate('personalInfo.inserDocumentNumber')}
        control={control}
        name="documentNumber"
        iconName={<UserScan />}
      />
